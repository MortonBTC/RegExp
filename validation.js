...
module.exports = {
    ...
    email: function (input) {
        var regexp = new RegExp('[A-Za-z_.]*[@]{1}[A-Za-z_.]*[.]{1}[A-Za-z]*');
        return regexp.test(input);
    },
    /**
    ...
    address: function (input) {
        var regexp = new RegExp('[0-9]*[ ]{1}[A-Za-z]*[(Ave)(St)(Park)(Lane)(Blvd)]{1}');
        return regexp.test(input);
    },
    /**
    ...
    username: function (input) {
        var regexp = new RegExp('[A-Za-z]{1}[A-Za-z0-9]*');
        return regexp.test(input);
    },
    /**
     ...
     */
    url: function (input) {
        var regexp = new RegExp('[(http)(https)]{1}[A-Za-z0-9.]*');
        return regexp.test(input);
    },
    ...
    ipaddr: function (input) {
        var regexp = new RegExp('[0-9]{1,3}[.]{1}[0-9]{1,3}[.]{1}[0-9]{1,3}[.]{1}');
        return regexp.test(input);
    },
};